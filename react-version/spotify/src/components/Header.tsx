  ...
  return (
    <header className="header">
      <div className="button-container">
        <button type="button" className="btn-header-back btn-header"></button>
        <button type="button" className="btn-header-forward btn-header"></button>
      </div>
      <button type="button" className="profile-header">
        ...
        <span className="profile-name">{info.display_name}</span>
      </button>
    </header>
  );
}
